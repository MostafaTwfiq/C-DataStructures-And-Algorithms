...
/** This function will take the address of the arrayDequeItem, and the dGFreeItem function address as a parameters,
 ...
 * @param freeItem the dGFreeItem function address
 */
